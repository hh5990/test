...
const physiognomyTypes = [
        { name: '철두철미한 계획가 관상', description: '모든 상황에 대비해 체계적인 계획을 세우며, 미래를 대비한 준비를 철저히 합니다. 변화하는 상황에서도 당황하지 않고, 이미 준비된 계획 B, C까지 동원하여 문제를 해결합니다. 현실적인 사실과 세부 정보에 기반하여 결정을 내리는 데 강점을 가지며, 일의 완성도를 중시합니다. 하지만, 감정 표현에 있어서는 다소 소극적이며 변화에 유연하게 적응하는 데 어려움을 겪을 수 있습니다. ' },
        { name: '연락하면 칼답할 관상', description: '메시지나 요청에 대한 응답을 매우 신속하게 합니다. 타인과의 소통을 중요시하며, 연락을 기다리게 하지 않는 것을 미덕으로 여깁니다. 친근하고 활발한 성격의 소유자로, 타인과의 관계를 중시하며 주변 사람들에게 따뜻한 관심을 보냅니다.하지만 때때로 너무 타인의 인정을 중요시하다 보니 자신의 필요나 감정을 소홀히 할 수 있습니다. 변화보다는 안정성을 추구하며, 주변 환경이나 상황이 예측 가능할 때 가장 편안함을 느낍니다.' },
        { name: '어떤 문제든 해결할 관상', description: '어떠한 문제에도 창의적이고 실용적인 해결책을 제시할 준비가 되어 있습니다. 복잡한 상황 속에서도 해결책을 찾아내는 능력이 뛰어납니다. 독립적이고 자기 주도적인 성향이 강하며, 자신의 능력을 최대한 활용하여 혁신적인 결과를 도출하기 위해 노력합니다. 감정적인 면에서는 타인과의 교류가 다소 어렵게 느껴질 수 있으며, 너무 이상적이거나 비현실적인 목표를 추구할 때가 있습니다.' },
        ...
        { name: '계획만 세우고 실천 안할 관상', description: '아이디어와 계획은 많지만, 실제로 실행에 옮기는 데는 어려움을 겪습니다. 꿈과 계획을 현실로 만드는 데 있어서 보다 구체적인 노력이 필요합니다. 이를 위한 노력을 지속한다면, 주변 사람들을 동기부여하고 이끌어가는 리더가 될 수 있는 잠재력을 가지고 있습니다. ' },
